...
class AIContentGenerator:
    ...
    def generate_enhanced_description(self, location_data: Dict) -> Optional[Dict]:
        ...
        try:
            ...
            logging.info(f"Generating enhanced description for {name} in {city}, {state}")
            ...
            logging.info(f"Successfully generated description for {name}")
            return ai_content
            
        except Exception as e:
            logging.error(f"Error generating AI content for {location_data.get('name', 'unknown location')}: {str(e)}")
            return None
    ...
    def generate_interaction_data(self, location_data: Dict) -> Optional[Dict]:
        ...
        try:
            ...
            logging.info(f"Generating interaction data for {name} ({location_type})")
            ...
            logging.info(f"Successfully generated interaction data for {name}")
            return interaction_data
            
        except Exception as e:
            logging.error(f"Error generating interaction data for {location_data.get('name', 'unknown location')}: {str(e)}")
            return None 